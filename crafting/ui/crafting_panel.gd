...
var recipe_item_scene = preload("res://crafting/ui/recipe_item_ui.tscn")
var ingredient_ui_scene = preload("res://crafting/ui/ingredient_ui.tscn")
var tooltip_scene = preload("res://crafting/ui/crafting_tooltip.tscn")
